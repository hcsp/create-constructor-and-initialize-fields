...
请在[Cat](https://github.com/hcsp/create-constructor-and-initialize-fields/blob/master/src/main/java/com/github/hcsp/pet/Cat.java)中新建一个指定的<ruby>构造器<rt>constructor</rt></ruby>。在提交Pull Request之前，你应当在本地确保所有代码已经编译通过，并且通过了测试(`mvn clean verify`)
